...
export const metadata: Metadata = {
  title: 'Datenschutzerklärung | LeitSalon',
  description: 'Datenschutzerklärung der LeitSalon Website.',
};
...
const sections = [
  {
    ...
    content: (
      <>
        <h3 className="text-sm font-bold text-brand-black mb-2">Allgemeine Hinweise</h3>
        <p className="mb-4">
        ...
        <h3 className="text-sm font-bold text-brand-black mb-2">Datenerfassung auf dieser Website</h3>
        <p className="mb-4">
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <h3 className="text-sm font-bold text-brand-black mb-2">Externes Hosting</h3>
        <p className="mb-4">
        ...
        <h3 className="text-sm font-bold text-brand-black mb-2">Auftragsverarbeitung</h3>
        <p>
  ...
  },
  {
    ...
    content: (
      <>
        <h3 className="text-sm font-bold text-brand-black mb-2">Datenschutz</h3>
        <p className="mb-4">
        ...
        <h3 className="text-sm font-bold text-brand-black mb-2">Hinweis zur verantwortlichen Stelle</h3>
        <p className="mb-4">
        ...
        <h3 className="text-sm font-bold text-brand-black mb-2">Speicherdauer</h3>
        <p className="mb-4">
        ...
        <h3 className="text-sm font-bold text-brand-black mb-2">Rechtsgrundlagen der Datenverarbeitung</h3>
        <p className="mb-4">
        ...
        <h3 className="text-sm font-bold text-brand-black mb-2">Widerruf Ihrer Einwilligung</h3>
        <p className="mb-4">
          Viele Datenverarbeitungsvorgänge sind nur mit Ihrer ausdrücklichen Einwilligung möglich. Sie können eine
          bereits erteilte Einwilligung jederzeit widerrufen. Die Rechtmäßigkeit der bis zum Widerruf erfolgten
          Datenverarbeitung bleibt vom Widerruf unberührt.
        </p>
        <h3 className="text-sm font-bold text-brand-black mb-2">Widerspruchsrecht (Art. 21 DSGVO)</h3>
        <p className="mb-4">
        ...
        <h3 className="text-sm font-bold text-brand-black mb-2">Beschwerderecht</h3>
        <p className="mb-4">
        ...
        <h3 className="text-sm font-bold text-brand-black mb-2">Recht auf Datenübertragbarkeit</h3>
        <p className="mb-4">
          Sie haben das Recht, Daten, die wir auf Grundlage Ihrer Einwilligung oder in Erfüllung eines Vertrags
          automatisiert verarbeiten, an sich oder an einen Dritten in einem gängigen, maschinenlesbaren Format
          aushändigen zu lassen.
        </p>
        <h3 className="text-sm font-bold text-brand-black mb-2">Auskunft, Berichtigung und Löschung</h3>
        <p className="mb-4">
        ...
        <h3 className="text-sm font-bold text-brand-black mb-2">Recht auf Einschränkung der Verarbeitung</h3>
        <p className="mb-4">
          Sie haben das Recht, die Einschränkung der Verarbeitung Ihrer personenbezogenen Daten zu verlangen.
        </p>
        <h3 className="text-sm font-bold text-brand-black mb-2">SSL- bzw. TLS-Verschlüsselung</h3>
        <p>
  ...
  },
  {
    ...
    content: (
      <>
        <h3 className="text-sm font-bold text-brand-black mb-2">Cookies</h3>
        <p className="mb-4">
        ...
        <h3 className="text-sm font-bold text-brand-black mb-2">Kontaktformular</h3>
        <p className="mb-4">
        ...
        <h3 className="text-sm font-bold text-brand-black mb-2">Anfrage per E-Mail, Telefon oder Telefax</h3>
        <p className="mb-4">
          Wenn Sie uns per E-Mail, Telefon oder Telefax kontaktieren, wird Ihre Anfrage inklusive aller daraus
          hervorgehenden personenbezogenen Daten (Name, Anfrage) zum Zwecke der Bearbeitung Ihres Anliegens
          bei uns gespeichert und verarbeitet. Diese Daten geben wir nicht ohne Ihre Einwilligung weiter.
        </p>
        <h3 className="text-sm font-bold text-brand-black mb-2">Terminbuchung</h3>
        <p>
